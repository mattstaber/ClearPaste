...
mkdir -p "$TEST_DIR"
swiftc -emit-library -emit-module -module-name PasteCore Sources/PasteCore/TextCleaner.swift -o "$TEST_DIR/libPasteCore.dylib" -emit-module-path "$TEST_DIR/PasteCore.swiftmodule"
